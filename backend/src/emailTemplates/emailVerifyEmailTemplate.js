...
const emailVerifyEmailTemplate = (email, otp) => {
  ...
  return `
        ...
        <body>
            <div class="container">
                ...
                <h1>Hello, <strong>${email}</strong>!</h1>
                ...
                <p>If you didn’t sign up for SD CHAT, you can safely ignore this email.</p>
                <p>Thanks,<br><span class="team_name">SD CHAT Team</span></p>
                <div class="footer">
...
module.exports = emailVerifyEmailTemplate;
